...
A real-time Japanese voice dictation program built with C++, using Whisper.cpp for speech recognition and PortAudio for audio capture.
...
- 🛠️ CMake build system with Clang compiler
...
# Korean
./build/rvtt models/ggml-base.bin ko
```
